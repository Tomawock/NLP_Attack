...
def objective(trial):
    ...
    units = trial.suggest_int('units', 16, 75)
    recurrent_dropout = trial.suggest_uniform('dropout', 0.05, 0.7)
    learning_rate = trial.suggest_float('learning_rate', 0.003, 0.009, step=0.0001)
...
with open('optuna_result_gru.pkl', 'wb') as result:
