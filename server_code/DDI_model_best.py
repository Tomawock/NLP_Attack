...
model.add(keras.layers.Bidirectional(layer=keras.layers.LSTM(units=137,
                                                             recurrent_dropout=0.46,
                                                             activation='tanh')))
...
print(metrics_2(model.predict(embedded_devset), five_hot_dev))
